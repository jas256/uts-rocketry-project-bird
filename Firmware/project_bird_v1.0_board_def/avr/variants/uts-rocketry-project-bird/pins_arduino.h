...
#define TX_RX_LED_INIT	__asm__("nop\n\t")//DDRD |= (1<<5), DDRB |= (1<<0)
#define TXLED0			__asm__("nop\n\t")//PORTD |= (1<<5)
#define TXLED1			__asm__("nop\n\t")//PORTD &= ~(1<<5)
#define RXLED0			__asm__("nop\n\t")//PORTB |= (1<<0)
#define RXLED1			__asm__("nop\n\t")//PORTB &= ~(1<<0)
...
#define LED_BUILTIN_RX 9
#define LED_BUILTIN_TX 10
